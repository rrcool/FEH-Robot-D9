...
#define SHAFT_ENCODER_COUNTS_FOR_45 100
#define SHAFT_ENCODER_COUNTS_FOR_90 200 //Determine these two by trial and error
FEHMotor leftGMH(FEHMotor::Motor0,12.0);
FEHMotor rightGMH(FEHMotor::Motor1,12.0);
...
//    }
    ...
    void driveFor(float distance, int percent){
        ...
        while((1/SHAFT_ENCODER_CYCLES_PER_INCH)*((right_encoder.Counts() + left_encoder.Counts()))/2<distance){
